...
extern int unregester_and_deinit_ontim_debug(struct ontim_debug *ontim_debug);
...
//+add by hzb for remove dev from ontim_debug
#define UNREGISTER_AND_DEINIT_ONTIM_DEBUG_FOR_THIS_DEV()\
         unregester_and_deinit_ontim_debug(ontim_debug_for_everyone)
//-add by hzb for remove dev from ontim_debug
